        ...
        <div className="px-4 md:px-0" onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
          ...
          <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
            ...
            <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
              ...
              <path d="M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h.172a2 2 0 0 0 1.414-.586l.814-.814a6.5 6.5 0 1 0-4-4z" /><circle cx="16.5" cy="7.5" r=".5" fill="currentColor" /></svg>
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-slate-800">AI Bullet Refiner</h3>
                <p className="text-sm text-slate-600 max-w-xs">Transform responsibilities into quantified, achievement‑driven bullet points.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-slate-800">ATS Optimization</h3>
                <p className="text-sm text-slate-600 max-w-xs">Get keyword suggestions tailored to job descriptions for better applicant tracking system scores.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-slate-800">Job‑Specific Tailoring</h3>
                <p className="text-sm text-slate-600 max-w-xs">Instantly generate role‑based resume versions with one click.</p>
              </div>
            </div>
          </div>
        </div>
