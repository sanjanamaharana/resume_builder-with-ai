...
const Dashboad = () => {
  ...
  const colors = ['#9333ea', '#d97706', '#dc2626', '#0284c7', '#16a34a', '#6366F1', '#EC4899', '#10B981', '#F59E0B', '#3B82F6', '#8B5CF6', '#EF4444', '#14B8A6', '#F97316', '#EAB308'];
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden' >Welcome, {user?.name || "guys"}</p>
